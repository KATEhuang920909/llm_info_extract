...
python main.py \
    ...
    --train_file_dir /root/autodl-tmp/sft_dpo_ppo_rm-main/datasets/compet_v1/ner_finetuning_train.json \
    --validation_file_dir /root/autodl-tmp/sft_dpo_ppo_rm-main/datasets/compet_v1/ner_finetuning_dev.json  \
